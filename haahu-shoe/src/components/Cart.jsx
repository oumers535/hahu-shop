    ...
    return (
      <aside className={`fixed top-0 right-0 h-full w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold select-none">Shopping Cart</h2>
          <button 
        ...
        <div className="p-4 overflow-y-auto h-[calc(100%-112px)]">
          {cartItems.length === 0 ? (
            <p className="text-gray-500 select-none">Your cart is empty.</p>
          ) : (
        ...
        {cartItems.length > 0 && (
          <footer className="p-4 border-t border-gray-200 select-none">
